...
<nav class="nav nav-pills nav-justified fixed-top" style="margin-top: 50px;">
    <a class="nav-link active" aria-current="page" href="index.php?e_url=<?= $_GET["e_url"] ?>">가정통신문</a>
    <a class="nav-link disable" href="notice.php?e_url=<?= $_GET["e_url"]; ?>">공지사항</a>
</nav>

<div class=" container" style="margin-top: 124px">
    <?php
    $rssUrl = 'https://grmr.gwe.hs.kr/grmr/0203/board/20561/rss.do';
