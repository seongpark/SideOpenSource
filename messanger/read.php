...
<div class="container" style="margin-top: 66px;">
    ...
    <div class="wrap mt-3 mb-2"><b>청원인</b></div>
    <span>
        <?php
        $loadWriterSql = mq("SELECT * FROM member WHERE idx='$please[writer]'");
        $loadWriter = $loadWriterSql->fetch_array();

        echo $loadWriter["grade"] . '학년 ';
        echo mb_substr($loadWriter["name"], 0, 1) . str_repeat('*', mb_strlen($loadWriter["name"]) - 1);
        ?>
